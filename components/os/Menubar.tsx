...
/**
 * Top menubar (28px). Left: site name. Right: clock, theme toggle, mute.
 */
...
export default function Menubar() {
  ...
  return (
    <div
      className="fixed top-0 left-0 right-0 z-[1000] flex h-7 items-center justify-between border-b px-3 text-[11px]"
      style={{
    ...
    >
      <span style={{ color: 'var(--text)' }}>jasonyi.live</span>
